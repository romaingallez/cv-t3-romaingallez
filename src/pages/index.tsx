            ...
            <div className="w-full bg-white p-8 sm:w-3/4">
              {showMewo ? (
                  ...
                  <div id="profile" className="prose">
                    ...
                    <p className="mb-2">
                      Actuellement en première année de Master en alternance dans
                      un cursus axé sur le développement informatique, après avoir
                      obtenu un Bac +3 en administration de systèmes et réseaux,
                      je poursuis mon ambition de diversifier mes compétences.
                    </p>
                    <p>
                      Mon objectif est d'explorer la galaxie DevOps, un domaine
                      qui allie l'administration systèmes et réseaux à la
                      programmation et au développement continu.
                    </p>
                    <p>
                      Mon parcours antérieur en tant qu'administrateur systèmes et
                      réseaux au sein de la fonction publique territoriale durant
                      ma troisième année d'alternance m'a permis d'acquérir une
                      solide expertise dans plusieurs domaines.
                    </p>
                ...
                <div id="profile" className="prose">
                  ...
                  <p className="mb-2">
                    Mon expérience m'a conféré une maîtrise approfondie de
                    divers outils et systèmes tels que Linux, Docker, Proxmox,
                    XCP-ng et Windows Active Directory, renforçant ainsi ma base
                    technique.
                  </p>

                  <h3 className="text-2l mb-2 mt-4 font-semibold">Cloud :</h3>
                  <p className="mb-2">
                    J'ai eu l'opportunité de travailler avec différentes
                    solutions cloud telles que OVHCLOUD, AWS, Clever Cloud et
                    Railway.app, enrichissant ma compréhension des
                    environnements cloud et des architectures distribuées.
                  </p>
